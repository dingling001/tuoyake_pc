  ...
  <div class="vbox">
    ...
    <div class="comitem">
      ...
      <div class="comminfo">
        ...
        <div class="comaddress view_num">
          <span class="collectbox" @click="clllection">
                 <span :class="['iconfont iconheart-fill', videoinfo.is_collection==1? 'iconactive':'']"></span>
          <span>{{videoinfo.is_collection==0?'收藏':'已收藏'}}</span>
          </span>
